...
<div class="row">
	<div class="panel panel-default">
		<div class="panel-heading">
			Recuperación de empleado
			<span class="pull-right clickable panel-toggle panel-button-tab-left"><em class="fa fa-toggle-up"></em></span></div>
			<div class="panel-body">
				<form class="form-horizontal" action="{{ url('empleado/recuperarsegundo') }}" method="post">
			        @csrf
					<fieldset>
						<!--idempleadojefe-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="id">Nombre de empleado</label>
							<div class="col-md-9">
